...
git_init(){
    git config --global user.name "lzj3278"
    git config --global user.email "lzj3278@gmail.com"
    git remote rm origin
    git remote add origin git@github.com:lzj3278/gcr.io.git
    git pull
